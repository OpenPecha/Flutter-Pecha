...
class GroupJoinRequestSuccessSheet extends StatelessWidget {
  final String groupName;

  const GroupJoinRequestSuccessSheet({super.key, required this.groupName});

  static Future<void> show(BuildContext context, {required String groupName}) {
    return showModalBottomSheet<void>(
      ...
      enableDrag: true,
      barrierColor: Colors.black.withValues(alpha: 0.5),
      builder: (_) => GroupJoinRequestSuccessSheet(groupName: groupName),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFFE8A045), width: 2),
                ),
                child: const Icon(
                  Icons.check,
                  size: 30,
              ...
              Text(
                l10n.group_join_request_success_title,
              ...
              Text(
                l10n.group_join_request_success_message(groupName),
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 15,
                  height: 1.4,
